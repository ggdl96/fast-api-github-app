...
class Step(BaseModel):
    ...
    conclusion: Optional[str] = Field(default=None, description="The final conclusion of the step (e.g., success, failure).")
    number: int = Field(..., description="The sequence number of the step.")
    started_at: Optional[datetime] = Field(default=None, description="Timestamp when the step started.")
    completed_at: Optional[datetime] = Field(default=None, description="Timestamp when the step completed.")
...
class WorkflowJob(BaseModel):
    ...
    conclusion: Optional[str] = Field(default=None, description="The final conclusion of the workflow job (e.g., success, failure).")
    created_at: datetime = Field(..., description="Timestamp for when the job was created.")
    started_at: Optional[datetime] = Field(default=None, description="Timestamp for when the job started.")
    completed_at: Optional[datetime] = Field(default=None, description="Timestamp for when the job completed.")
    ...
    runner_id: Optional[int] = Field(default=None, description="The ID of the runner executing the job.")
    runner_name: Optional[str] = Field(default=None, description="The name of the runner executing the job.")
    runner_group_id: Optional[int] = Field(default=None, description="The group ID of the runner.")
    runner_group_name: Optional[str] = Field(default=None, description="The group name of the runner.")
class Installation(BaseModel):
    id: int = Field(..., description="ID")
    node_id: Optional[str] = Field(default=None, description="Node ID for the installation")
...
class WorkflowRun(BaseModel):
    ...
    conclusion: Optional[str] = Field(default=None, description="The final conclusion of the workflow run")
...
class RequestPayloadWebhook(BaseModel):
